...
public class KeepAlivePacket extends GenericSendPacket {
	
	public KeepAlivePacket() {
		setAttributeValue("value", XfireUtils.getValueShortInt(0));
		setAttributeValue("stats", XfireUtils.getValueEmptyArray(XfireAttributeValueType.SHORT_INT));
	}
